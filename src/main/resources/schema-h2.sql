...
CREATE INDEX idx_pack_member   ON pack(member_id);
CREATE INDEX idx_pack_like     ON pack(pack_like_count);
CREATE INDEX idx_pack_bookmark ON pack(pack_bookmark_count);
CREATE INDEX idx_pack_comment ON pack(pack_comment_count);

ALTER TABLE pack ADD CONSTRAINT chk_pack_price_nonneg CHECK (price IS NULL OR price >= 0);
...
ALTER TABLE pack ADD CONSTRAINT chk_pack_comment_nonneg CHECK (pack_comment_count >= 0);
...
ALTER TABLE pack_item
    ADD CONSTRAINT fk_pack_item_pack
        FOREIGN KEY (pack_id)
            REFERENCES pack(id)
            ON DELETE CASCADE
            ON UPDATE CASCADE;
...
CREATE UNIQUE INDEX uk_hashtag_name ON hashtag(name);
ALTER TABLE hashtag ADD CONSTRAINT chk_hashtag_usage_count CHECK (usage_count >= 0);
------------------------------------------------------------
...
CREATE UNIQUE INDEX uk_feed_hashtag ON feed_hashtag(feed_id, hashtag_id);
CREATE INDEX idx_fh_hashtag ON feed_hashtag(hashtag_id);

ALTER TABLE feed_hashtag ADD CONSTRAINT chk_fh_tag_order CHECK (tag_order >= 0);

ALTER TABLE feed_hashtag
    ADD CONSTRAINT fk_fh_feed
        FOREIGN KEY (feed_id)
            REFERENCES feed(id)
            ON DELETE CASCADE
            ON UPDATE CASCADE;
...
ALTER TABLE feed_hashtag
    ADD CONSTRAINT fk_fh_hashtag
        FOREIGN KEY (hashtag_id)
            REFERENCES hashtag(id)
            ON DELETE CASCADE
            ON UPDATE CASCADE;
------------------------------------------------------------
-- 13) 취미 팩-해시태그 연관테이블 (pack_hashtag)
------------------------------------------------------------
...
CREATE UNIQUE INDEX uk_pack_hashtag ON pack_hashtag(pack_id, hashtag_id);
CREATE INDEX idx_ph_hashtag ON pack_hashtag(hashtag_id);

ALTER TABLE pack_hashtag ADD CONSTRAINT chk_ph_tag_order CHECK (tag_order >= 0);

ALTER TABLE pack_hashtag
    ADD CONSTRAINT fk_ph_pack
        FOREIGN KEY (pack_id)
            REFERENCES pack(id)
            ON DELETE CASCADE
            ON UPDATE CASCADE;
...
ALTER TABLE pack_hashtag
    ADD CONSTRAINT fk_ph_hashtag
        FOREIGN KEY (hashtag_id)
            REFERENCES hashtag(id)
            ON DELETE CASCADE
            ON UPDATE CASCADE;
-- ------------------------------------------------------------
-- 14) 취미 팩-해시태그 연관테이블 (pack_hashtag)
-- ------------------------------------------------------------
CREATE TABLE pack_hashtag (
